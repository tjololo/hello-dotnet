...
public class EventsReceiver1 : IEventReceiver
{
    ...
    {
        _logger.LogInformation($"Pre Event processing for method {args.Method} in receiver 1");
    ...
    {
        _logger.LogInformation($"Post Event processing for method {args.Method} in receiver 1");
        await Task.Delay(args.Delay);
