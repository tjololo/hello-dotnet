...
public class RequestHandler : IRequestHandler
{
    ...
    {
        _logger.LogInformation("Delegating process pre event for method {method} with dealy {delay}", method, delay);
    ...
    {
        _logger.LogInformation("Delegating process post event for method {method} with dealy {delay}", method, delay);
